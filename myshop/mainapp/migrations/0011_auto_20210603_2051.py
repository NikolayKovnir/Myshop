# Generated by Django 3.2.2 on 2021-06-03 20:51
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0010_auto_20210603_1652'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adress', models.CharField(blank=True, max_length=1024, null=True, verbose_name='Адресс')),
                ('status', models.CharField(choices=[('new', 'Новый заказ'), ('in_progress', 'Заказ в обработке'), ('ready', 'Заказ готов'), ('completed', 'Заказ выполнен')], default='new', max_length=100, verbose_name='Статус заказ')),
